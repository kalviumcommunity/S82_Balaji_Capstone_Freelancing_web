      ...
      <div className="main-content">
        ...
        <div className="recruiter-profile">
          ...
          <div className="profile-info">
            <h2>{user.name}</h2>
            <p>Recruiter at Freelance Platform</p>
          </div>
        </div>
        ...
        <div className="notifications">
          <h3>Notifications</h3>
          <div className="notification-item">New project posted</div>
          <div className="notification-item">Freelancer submitted project</div>
        </div>
      </div>
    </div>
  );
